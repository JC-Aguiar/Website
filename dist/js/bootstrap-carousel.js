...
+(function ($) {
    ...
    BootstrapCarousel.prototype = {
        template: {
            ...
            carouselInner:
                '<div class="carousel-inner" role="listbox">{innerContent}</div>',
            carouselItem:
                "" +
            ...
            carouselIndicatorItem:
                '<li data-target="#{elementId}" data-slide-to="{slideNumber}" {activeClass}></li>',
            carouselControls:
                "" +
        ...
        createSlideDeck: function () {
            ...
            return this.template.carouselInner.replace(
                /{innerContent}/,
                slideTemplate
            );
        },
        ...
        createSlide: function (active, itemImg, itemTitle, itemContent) {
            return this.template.carouselItem
                ...
                .replace(
                    /{itemContent}/,
                    itemContent || this.options.defaultContent
                );
        },
    };
    ...
    function Plugin(option) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                $this.data(
                    "bootstrap-carousel",
                    (data = new BootstrapCarousel(this, options))
                );
            }
